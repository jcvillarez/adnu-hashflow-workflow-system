  ...
  methods: {
    async editPassword() {
      try {
        ...
        password.set("id", passwordId);
        password.set("password", this.changePassword);
        password.set("confirm_password", "");
        
        password.save();

        alert("Succesfully Changed Password!");
        this.$router.push({ name: "home", query: { passwordId: passwordId } });
      } catch (error) {
