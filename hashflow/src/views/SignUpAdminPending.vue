  ...
  <div class="popup-email-body">
    <div class="popup-email-content">
      <div class="popup-email-frame">
        <span>Organization Creation on Request</span>
        <p>
          Your application has been sent to the organizers of this system.
          Please wait for their response in your email. Thank you!
        </p>
      </div>
    </div>
  </div>
