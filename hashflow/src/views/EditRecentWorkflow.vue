...
<template>
  <div class="indv-edit-body">
    <NavBarComponent />
    <div class="indv-edit-content">
      <span>Edit Recent Workflow</span>

      <form
        class="indv-edit-table-frame"
...
export default {
  ...
  mounted: async function () {
    const WorkflowTemplate = Parse.Object.extend("Workflow_Template");
