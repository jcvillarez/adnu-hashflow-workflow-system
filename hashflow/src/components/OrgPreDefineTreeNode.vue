...
export default {
  ...
  methods: {
    ...
    createButton(text, action) {
      ...
      button.classList = `
          border-[1px] border-[#F18642] bg-[#F18642] text-white text-[13px] p-[10px] w-[150px] hover:border-[#F18642] rounded-[5px]
    ...
    initializeList(parent) {
      ...
      button.onclick = () => {
        ...
        container.classList =
          "flex flex-row gap-5 items-center justify-center border-[5px] border-[#F18642]/20 p-[30px] rounded-[5px]";
        ...
        let submit = this.createButton("OK", async () => {
          ...
          item.classList =
            "flex flex-row gap-3 items-center justify-end bg-[#F18642] text-white pt-[5px] px-[5px]";
          ...
          addChildButton.classList = `
            border-[1px] border-[#F18642] bg-black/10 text-white text-[13px] p-[10px] w-[120px] rounded-[5px]
            hover:bg-black/20 hover:text-white hover:duration-75
          `;
