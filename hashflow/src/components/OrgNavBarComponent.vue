...
<template>
  <div class="org-nav-frame">
    ...
    <div class="org-nav">
      <router-link :to="{ name: 'orgDashboard' }">Dashboard</router-link>
      <div class="indv-nav-dropdown">
        <span>Workflow</span>
        <div class="indv-nav-dropdown-content">
          <router-link :to="{ name: 'orgRecentWorkflow' }"
            >Recently Initiated Workflow</router-link
          >
          <router-link :to="{ name: 'orgPredefinedWorkflow' }"
            >Pre-Defined Workflow</router-link
          >
          <router-link :to="{ name: 'orgWorkflowInitiation' }"
            >Create Custom Workflow</router-link
          >
        </div>
      </div>

      <router-link :to="{ name: 'orgNotifications' }">
        Notifications
      </router-link>
      ...
      <div class="admin-nav-dropdown">
        ...
        <div class="admin-nav-dropdown-content">
          <router-link :to="{ name: 'OrgProfile' }">Profile</router-link>
