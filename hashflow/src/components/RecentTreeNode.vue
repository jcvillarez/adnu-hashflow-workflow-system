<style>
.indv-recent-treestructure-body {
...
.indv-recent-treestructure-content {
  @apply flex flex-col items-center justify-start gap-[30px] grow w-full max-w-[1280px] py-[30px];
} /* lock */

.indv-recent-treestructure-content > span {
  @apply font-black text-[35px] text-left w-full px-[5px];
} /* lock */

.indv-recent-treestructure-content > form > button {
  @apply border-[1px] border-[#F18642] bg-[#F18642] text-white text-[13px] p-[10px] w-[150px];
}
.indv-recent-treestructure-content > form > button:hover {
  @apply border-[#F18642] bg-transparent text-[#F18642] duration-75;
}

.indv-recent-treestructure-frame {
  @apply overflow-auto w-full h-[1px] grow border-2 border-[#F18642] p-[30px] bg-white;
}
.indv-recent-treestructure-frame > ul {
  @apply inline-block;
}

.indv-recent-treestructure-frame > table {
  @apply w-full;
}

.indv-recent-treestructure-frame > table > tbody > tr {
  @apply border-b-[1px] border-b-[#aaa];
}

.indv-recent-treestructure-frame > table > thead > tr > th {
  @apply text-[13px] p-[10px] font-bold sticky top-0 bg-white border-none;
}
.indv-recent-treestructure-frame > table > tbody > tr > td {
  @apply text-left text-[13px] border-none p-[10px];
}
</style>

<template>
  <div class="indv-recent-treestructure-body">
    <div class="indv-recent-treestructure-content">
      <span>Workflow Structure</span>
      <div class="indv-recent-treestructure-frame">
